...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<!-- <iframe name="I1" height="100%" width="156" src="left.jsp" border="0" frameborder="0" scrolling="no">
	浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</iframe>	 -->
		<jsp:include page="left.jsp"></jsp:include>
	</td>
    <td width="4" valign="middle" background="<%request.getContextPath();%>Pages/indexParts/images/main_27.gif" 
